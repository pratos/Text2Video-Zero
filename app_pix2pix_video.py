...
def create_demo(model: Model):
    examples = [
        ...
        ['__assets__/pix2pix_video_2fps/demo-sample1.mov',
            'make it Van Gogh Starry Night', 512, 0, 1.5],
        ['__assets__/pix2pix_video_2fps/demo-sample2.mov',
            'make it watercolor painting', 512, 0, 1.5],
